...
import arms from '@/assets/arm.svg'

export default function Arms({ exercises = [], updateMaxWeight, onMuscleClick }) {
  return (
    <div>
      <button 
      ...
      > 
        <img src={arms} alt="Arms exercise icon" className="w-14 h-14 justify-center"/>
        <p className='font-bold'>Arms</p>
