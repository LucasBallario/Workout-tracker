...
export default function Abs({ exercises = [], updateMaxWeight, onMuscleClick }) {
  return (
    <div>
      <button 
      ...
      > 
        <img src={abs} alt="Abs exercise icon" className="w-14 h-14 justify-center"/>
          ...
          <div key={exercise.name} className="w-full px-2 mt-2">
            <div className="flex flex-col items-start gap-1 w-full">
              ...
              <div className="flex gap-2 text-sm w-full">
                ...
                <span>Secs: {exercise.reps || 0}</span>
